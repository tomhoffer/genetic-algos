...
from src.selection import select_roulette
...
def test_empty_population(empty_population):
    with pytest.raises(ValueError) as err:
        select_roulette(empty_population)
...
def test_all_zero_fitness(population_with_zero_fitness):
    ...
    result: List[Solution] = select_roulette(population=population_with_zero_fitness)
...
def test_all_identical(population_with_positive_fitness):
    ...
    result: List[Solution] = select_roulette(population=population_with_positive_fitness)
